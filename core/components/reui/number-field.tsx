...
function NumberFieldDecrement({
  ...
  return (
    <NumberFieldPrimitive.Decrement
      className={cn(numberFieldButtonVariants({ size }), "rounded-s-2xl border-e-0", className)}
...
function NumberFieldIncrement({
  ...
  return (
    <NumberFieldPrimitive.Increment
      className={cn(numberFieldButtonVariants({ size }), "rounded-e-2xl border-s-0", className)}
