...
function DataGridTableResizeIndicator({
  ...
  return (
    ...
    >
      ...
      <div
        className="bg-primary absolute top-0 left-0 -translate-x-1/2 rounded-b-lg shadow-xs"
        style={{
          width: 5,
...
function DataGridTableBody({ children }: { children: ReactNode }) {
  ...
  return (
    <tbody
      ...
      className={cn(
        props.tableLayout?.rowRounded && "[&_td:first-child]:rounded-l-2xl",
        props.tableLayout?.rowRounded && "[&_td:last-child]:rounded-r-2xl",
