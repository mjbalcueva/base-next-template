...
function MenubarTrigger({ className, ...props }: React.ComponentProps<typeof DropdownMenuTrigger>) {
  return (
    <DropdownMenuTrigger
      ...
      className={cn(
        "hover:bg-muted aria-expanded:bg-muted flex items-center rounded-2xl px-1.5 py-0.5 text-sm font-medium outline-hidden select-none",
        className
      )}
      {...props}
    />
...
function MenubarLabel({
  ...
  return (
    <DropdownMenuLabel
      ...
      data-inset={inset}
      className={cn("text-muted-foreground px-2 py-1 text-sm data-inset:pl-7", className)}
      {...props}
    />
  )
}
